...
for high_num in numbers_high_to_low:
    for low_number in numbers_low_to_high:
        for low_number_2 in numbers_low_to_high:
            num_sum = high_num + low_number + low_number_2
            print(f'{high_num} + {low_number} + {low_number_2} = {num_sum}')
            if num_sum > 2020:
                print('To high...')
                break
            elif num_sum < 2020:
                ...
                print('Found it...')
                print(f'Answer: {low_number * high_num * low_number_2}')
                sys.exit()
